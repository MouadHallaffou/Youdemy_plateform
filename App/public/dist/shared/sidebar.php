        ...
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <div class="collapse" id="collapseCourses" aria-labelledby="headingCourses" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="http://localhost/Youdemy_plateform/App/views/view_courses.php">Voir cours</a>
                        <a class="nav-link" href="http://localhost/Youdemy_plateform/App/views/manage_courses.php">Gérer les cours</a>
                    </nav>
                </div>
            </div>
        </div>
