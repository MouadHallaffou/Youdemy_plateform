                                ...
                                <tbody>
                                    <?php foreach ($teachers as $teacher): ?>
                                        <tr>
                                            ...
                                            <!-- validate_teachers.php -->
                                            <td>
                                                <!-- Accepter l'enseignant (changer son statut à 'active') -->
                                                <a href="../controllers/crud_teachers.php?action=accept&id=<?= htmlspecialchars($teacher['user_id']); ?>" class="btn btn-sm btn-success">
                                                    <i class="fas fa-check"></i> Accepter
                                                </a>
                                                <!-- Changer l'enseignant en étudiant (changer son rôle à 'etudiant' et son statut à 'active') -->
                                                <a href="../controllers/crud_teachers.php?action=change_to_student&id=<?= htmlspecialchars($teacher['user_id']); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir changer cet enseignant en étudiant ?');">
                                                    <i class="fas fa-exchange-alt"></i> Changer en étudiant
                                                </a>
                                            </td>
