                                ...
                                <tbody>
                                    <?php foreach ($teachers as $teacher): ?>
                                        <tr>
                                            ...
                                            <td>
                                            <a href="../controllers/crud_users.php?action=accept&id=<?= htmlspecialchars($teacher['user_id']); ?>" class="btn btn-sm btn-success">
                                                    <i class="fas fa-check"></i> Accepter
                                                </a>
                                                <a href="../controllers/crud_users.php?action=change_to_student&id=<?= htmlspecialchars($teacher['user_id']); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir changer cet enseignant en étudiant ?');">
