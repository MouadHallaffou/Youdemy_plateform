...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-2" href="index.html">YOUDEMY</a>
        <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <!-- Fetching the Tag -->
                    <?php
                    // Assuming you retrieve the tag based on the ID passed in the URL
                    require_once '../controllers/crud_tags.php'; // Ensure the tag is available
                    $tagId = $_GET['id'] ?? null;
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $totaltags ?? 0; ?></div>
                                        </div>
                                        <div class="col-auto">
